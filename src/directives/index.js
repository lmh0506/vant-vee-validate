import Vue from 'vue'
import { judgeDeviceType } from '@/common/js/utils'

let judgeDevice = judgeDeviceType()
...
Vue.directive('keyboardfocus', {
  inserted: function (el) {
    let dom = el.querySelector('input[type=text]') || el.querySelector('input[type=textarea]')
    listenKeybord(dom)
  }
})
